...
const OfferCard = ({ imageSrc, title, description, price }: OfferCardProps) => {
  return (
    <div className="flex flex-col items-center bg-white shadow-lg rounded-lg p-4 hover:scale-105 transition-transform duration-300">
      ...
      {/* Offer Details */}
      <h3 className="text-lg font-bold text-center text-[#1E1E1E] mb-2">{title}</h3>
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 sm:p-6 md:p-8">
      ...
      <div className="mb-8 text-center">
        <p className="text-red-500 text-sm tracking-wider font-semibold">LIMITED TIME OFFERS</p>
        <h2 className="text-2xl sm:text-3xl font-bold tracking-wide text-black">Exclusive Deals for You</h2>
      </div>
