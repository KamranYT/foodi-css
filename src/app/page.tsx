      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none font-bold mt-10">
            <h1 className="h1 mb-6 text-black xl:text-6xl xl:ml-28">
              Dive into Delights <br />
              Of Delectable{" "}
              <span className="text-[#39DB4A]">Food</span>
            </h1>
            <p className="max-w-[500px] mb-9 text-[#4A4A4A] font-medium text-2xl xl:ml-28">
              Where Each Plate Weaves a Story of Culinary <br />
              Mastery and Passionate Craftsmanship
            </p>
            {/* Button */}
            <div className="flex flex-col xl:flex-row items-center gap-8 xl:ml-28">
              <Button
                variant="outline"
                size="lg"
